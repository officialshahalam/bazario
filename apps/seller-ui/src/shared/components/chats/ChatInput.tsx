...
const ChatInput = ({
  ...
  return (
    <form
      ...
      className="border-t border-t-gray-800 bg-gray-900 px-4 py-3 flex items-center gap-2 relative"
    >
      <label>
      ...
      <input type="text"
        ...
        className="flex-1 px-4 py-2 text-sm border bg-gray-700 border-gray-950 outline-none rounded-md"
      />
